...
{
    public class
    SystemGeneratedAttributesGraphType
    : ObjectGraphType<SystemGeneratedAttributesModel>
    {
        public SystemGeneratedAttributesGraphType()
        {
            Name = "Asset_SystemGeneratedAttributes";
