...
namespace DAM.GraphQL.Schemas.Asset
{
    ...
    public class RightsModel : MutableModel
    {
        ...
        public static implicit operator RightsModel(
            Services.Models.Asset.Rights entity
        )
        ...
        public static RightsModel
        FromEntity(Services.Models.Asset.Rights entity)
        {
        ...
        FromEntityList(List<Services.Models.Asset.Rights> entityList)
        {
            if (entityList == null)
            {
                return null;
