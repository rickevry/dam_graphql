...
namespace DAM.Core.DataModels.Asset
{
    ...
    public class AssetModel : MutableModel
    {
        ...
        private List<string> _corporate;

        private List<string> _publishingChannelStates;
        ...
        private string _customerChannel;

        private List<string> _assetSites;
        ...
        /// WebPim,Tridion
        /// </summary>
        public List<string> PublishingChannelStates
        {
            get
            {
        ...
        public string confirmedBy
        {
            ...
            set
            {
                SetField(ref _confirmedBy, value);
            }
        }
